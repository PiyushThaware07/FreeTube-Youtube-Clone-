                        ...
                        <ul>
                            ...
                            <hr />
                            {
                                itemsList01.map((item, index) => (
                                    <li key={index} className='px-[30px] py-[12px] md:py-[16px]'><button className='flex flex-nowrap items-center text-[20px] font-semibold gap-2'>{item.icon}<span className='text-[13px] capitalize'>{item.name}</span></button></li>
                                ))
                            }
